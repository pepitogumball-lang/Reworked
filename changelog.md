...
* Updated to Geode v5.6.1 and C++23.
* Migrated APIs to latest Geode standards (Result, matjson, includes).
* Updated GD version to 2.2081 for latest compatibility.
* Updated custom-keybinds dependency to v3.0.0+.
* Fixed various compatibility issues and API deprecations.
* Improved logging messages and event handling.
